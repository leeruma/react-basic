...
// 비동기 서버통신으로 데이터를 전달받아서 내부적으로 action 타입을 자동 생성해서 액션객체 생성까지 완료하는 함수
...
/*
  ...
  action : dispatch로 reducer에게 데이터 변경용청을 위해 필요한 특별한 형태의 객체 (창구직원에게 전달하기 위한 지로용지)
  ...
  4-변경된 store데이터는 index.js에 의해서 App.jsx에 전달됨
  5-루트 컴포넌트인 App.jsx에 데이터가 전달되었기 때문에 자식 컴포넌트 어디에서든 해당 데이터에 접근가능
*/
